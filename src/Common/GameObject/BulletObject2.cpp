...
#include		"BulletObject2.hpp"

namespace		GameObject
{
  //************GAMEOBJECTCLIENT************************//

  BulletObject2::BulletObject2()
  {
    this->name_ = "charge";
  ...
  void					BulletObject2::initObject(float posX, float posY, float width,
  ...
  void						BulletObject2::destroyObject()
  {

  }

  bool						BulletObject2::update(float timer)
  {
    if (timer <= 0.0f)
      this->launched_ = true;
  ...
  bool						BulletObject2::update(const Network::Packet & packet)
  {
  ...
  bool						BulletObject2::update(float, Protocol::eEvent)
  {
    return true;
  }

  bool						BulletObject2::isFiring(float timer)
  {
    return false;
  }
}
...
{
  return new GameObject::BulletObject2;
}
